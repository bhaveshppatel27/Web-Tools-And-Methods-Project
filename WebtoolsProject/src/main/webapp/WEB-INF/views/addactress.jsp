...
<script type="text/javascript" src="resources/actress.js"></script>
			...
			<div id="login-overlay" class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel">Enter Actress to
							Database</h4>
					</div>
								...
								<div class="form-group">
									<div class="input-group-addon">
										<div class="col-xs-4">
											...
											<button type="button" onclick="addactress()" id="add"
												class="btn btn-success">Add</button>
											<button type="button" onclick="addactr()" id="addmore"
...
function addactress(){
	...
	RemoteService.checkActress(firstname,lastname,skills, {
